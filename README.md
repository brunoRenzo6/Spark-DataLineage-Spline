...
* O projeto do SPLINE foi desenvolvido somente para o Spark Scala ([Issue: Integrate spline with pyspark #48](https://github.com/AbsaOSS/spline/issues/48 "Issue: Integrate spline with pyspark #48")). [Segue documentação](https://github.com/brunoRenzo6/Spark-DataLineage-Spline/blob/main/Integra%C3%A7%C3%A3o.md "Segue documentação") de como integrar o SPLINE com o <strong>PySpark</strong>.
